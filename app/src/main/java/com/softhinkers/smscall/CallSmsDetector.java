package com.softhinkers.smscall;
...
import com.softhinkers.smscall.DeviceAdminActivity;
import com.softhinkers.smscall.PermissionsActivity;
...
/**
 * Created by Adarsh Maurya on 18-04-2017.
 *
 * How to use this class?
 *
 * First ask for permissions using {@link #askForPermissions(Context)}
 * Then set listeners using {@link com.softhinkers.smscall.sms.SmsReceiver#setSmsReceivedListener(SmsReceivedListener)} to detect received sms,
 * {@link SmsObserver#setSmsSentListener(SmsSentListener)} to detect sent sms,
 * {@link com.softhinkers.smscall.call.PhoneCallReceiver#setCallListener(CallListener)} to detect calls
 */
