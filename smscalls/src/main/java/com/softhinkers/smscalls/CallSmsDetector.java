 ...
 * Then set listeners using {@link com.softhinkers.smscalls.sms.SmsReceiver#setSmsReceivedListener(SmsReceivedListener)} to detect received sms,
 * {@link SmsObserver#setSmsSentListener(SmsSentListener)} to detect sent sms,
 * {@link com.softhinkers.smscalls.call.PhoneCallReceiver#setCallListener(CallListener)} to detect calls
 */
